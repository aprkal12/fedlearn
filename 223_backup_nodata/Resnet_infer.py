...
if __name__ == '__main__':
    ...
    # parameters = infer.parameter_extract()  # 예시로 파라미터 추출
    ...
    # print(utils.bytes_to_mb(len(json_data)))
    ...
    # print("파라미터 사이즈 : %.2f MB" % utils.bytes_to_mb(len(zstddata)))
    ...
    wandb.run.name = "Resnet18_CIFAR-10_D=100%"
